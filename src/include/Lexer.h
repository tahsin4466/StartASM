...
namespace LexerConstants {
    enum TokenType {INSTRUCTION, CONJUNCTION, JUMPCONDITION, TYPECONDITION, SHIFTCONDITION, DESCRIPTOR, REGISTER, INSTRUCTIONADDRESS, MEMORYADDRESS, INTEGER, FLOAT, BOOLEAN, CHARACTER, LABEL, STRING, BLANK, NEWLINE, UNKNOWN};
};
