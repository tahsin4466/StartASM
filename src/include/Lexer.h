...
namespace LexerConstants {
    enum TokenType {INSTRUCTION, CONJUNCTION, CONDITION, DESCRIPTOR, REGISTER, INSTRUCTIONADDRESS, MEMORYADDRESS, INTEGER, FLOAT, BOOLEAN, CHARACTER, LABEL, COMMENT, BLANK, UNKNOWN};
};
