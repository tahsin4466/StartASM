...
namespace LexerConstants {
    enum TokenType {INSTRUCTION, CONJUNCTION, CONDITION, DESCRIPTOR, REGISTER, INSTRUCTIONADDRESS, MEMORYADDRESS, INTEGER, FLOAT, BOOLEAN, CHARACTER, LABEL, STRING, BLANK, NEWLINE, UNKNOWN};
};
