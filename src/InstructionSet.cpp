...
InstructionSet::InstructionSet() {
    ...
    m_templateMap.emplace("add", vector<string>{"add r[0-9] and r[0-9] to r[0-9]"});
    m_templateMap.emplace("subtract", vector<string>{"subtract r[0-9] and r[0-9] to r[0-9]"});
    m_templateMap.emplace("multiply", vector<string>{"multiply r[0-9] and r[0-9] to r[0-9]"});
    m_templateMap.emplace("divide", vector<string>{"divide r[0-9] and r[0-9] to r[0-9]"});
    ...
    m_templateMap.emplace("increment", vector<string>{"increment r[0-9]"});
    m_templateMap.emplace("decrement", vector<string>{"decrement r[0-9]"});
    ...
    m_templateMap.emplace("push", vector<string>{"push from r[0-9]"});
    m_templateMap.emplace("pop", vector<string>{"pop to r[0-9]"});
    m_templateMap.emplace("skip", vector<string>{"skip"});
