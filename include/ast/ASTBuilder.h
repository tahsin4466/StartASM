...
private:
    ...
    using OperandFactory = std::function<AST::OperandNode*(const std::string&, int line, short int pos)>;
    ...
    AST::OperandNode* operandBuilder(ASTConstants::OperandType nodeType, const std::string& value, int line, short int pos);
};
